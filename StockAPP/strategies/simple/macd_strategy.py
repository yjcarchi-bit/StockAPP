...
class MACDStrategy(StrategyBase):
    ...
    def initialize(self) -> None:
        """初始化策略"""
        self.fast_period = self.get_param("fast_period", self.fast_period)
        self.slow_period = self.get_param("slow_period", self.slow_period)
        self.signal_period = self.get_param("signal_period", self.signal_period)
        self.use_histogram = self.get_param("use_histogram", self.use_histogram)
