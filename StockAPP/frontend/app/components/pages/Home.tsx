      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="flex items-start">
            ...
            <div>
              <h3 className="font-medium text-foreground">零代码操作</h3>
              <p className="text-sm text-muted-foreground">图形化界面，无需编程背景即可进行专业策略分析</p>
            </div>
          </div>
          <div className="flex items-start">
            <div className="flex-shrink-0 w-8 h-8 bg-primary/10 rounded-full flex items-center justify-center mr-3">
            ...
            <div>
              <h3 className="font-medium text-foreground">完整回测引擎</h3>
              <p className="text-sm text-muted-foreground">支持交易费用、滑点等真实市场因素模拟</p>
            </div>
          </div>
          <div className="flex items-start">
            <div className="flex-shrink-0 w-8 h-8 bg-primary/10 rounded-full flex items-center justify-center mr-3">
            ...
            <div>
              <h3 className="font-medium text-foreground">多维度分析</h3>
              <p className="text-sm text-muted-foreground">提供收益、风险、夏普比率等专业指标分析</p>
            </div>
          </div>
        </CardContent>
      </Card>
